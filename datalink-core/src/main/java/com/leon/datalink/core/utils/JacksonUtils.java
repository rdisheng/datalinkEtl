...
import com.leon.datalink.core.exception.impl.DataDeserializationException;
import com.leon.datalink.core.exception.impl.DataSerializationException;
...
public final class JacksonUtils {
     ...
     * @param obj obj
     * @return json string
     * @throws DataSerializationException if transfer failed
     */
    public static String toJson(Object obj) {
        try {
            ...
            throw new DataSerializationException(obj.getClass(), e);
        }
    }
     ...
     * @return object
     * @throws DataDeserializationException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            return toObj(StringUtils.newStringForUtf8(json), cls);
        } catch (Exception e) {
            throw new DataDeserializationException(cls, e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new DataDeserializationException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new DataDeserializationException(type, e);
        }
    }
